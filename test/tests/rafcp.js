...
const tempDir = "test/rafcp";

describe("component command", () => {
  before("create temp folder", () => {
    utils.createFolder("test", "rafcp");
  });
  // ========================================
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name}`, () => {
    afterEach(() => {
    ...
    it("should create correct number of files/folders", () => {
      const nodeProcess = spawnSync(
        "node",
        [rg, "c", "rafcp", fileNames.component.name],
        {
          cwd: tempDir,
        }
      );
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --cssType modular`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
      const nodeProcess = spawnSync(
        "node",
        [rg, "c", "rafcp", fileNames.component.name, "--cssType", "modular"],
        {
          cwd: tempDir,
        }
      );
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --test`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
      const nodeProcess = spawnSync(
        "node",
        [rg, "c", "rafcp", fileNames.component.name, "--test"],
        {
          cwd: tempDir,
        }
      );
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --test --testExt test-tsx`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --test --testExt spec-js`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --test --testExt spec-tsx`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --ext jsx`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
      const nodeProcess = spawnSync(
        "node",
        [rg, "c", "rafcp", fileNames.component.name, "--ext", "jsx"],
        {
          cwd: tempDir,
        }
      );
  ...
  // ========================================
  describe(`rg c rafcp ${fileNames.component.name} --ext tsx`, () => {
    afterEach(() => {
      support.removeFolder(tempDir, fileNames.component.pascalName);
    });
    it("should create correct number of files/folders", () => {
      const nodeProcess = spawnSync(
        "node",
        [rg, "c", "rafcp", fileNames.component.name, "--ext", "tsx"],
        {
          cwd: tempDir,
        }
      );
  ...
  after("remove temp folder", () => {
    support.removeFolder("test", "rafcp");
  });
});
